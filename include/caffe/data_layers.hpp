...
class Batch {
 public:
  Blob<Dtype> data_, label_, meta_label_; // Karim: added "meta_label_", to use inside MapDataLayer
};
...
class MapDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  ...
  virtual void setLabelsMap(vector<int> new_labels_map);
  virtual vector<int> getLabelsMap() ;
 ...
 protected:
  ...
  DataReader reader_;
  string labels_map_file_;
  vector<int> labels_map_;
};
