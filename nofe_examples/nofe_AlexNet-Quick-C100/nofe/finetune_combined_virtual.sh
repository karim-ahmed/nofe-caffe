...
GLOG_logtostderr=1 /PATH_TO/caffe.bin train \
    ...
    --snapshot=snapshots/caffe_combined_train_iter_60000.solverstate   2>&1 | tee combined_virtual_lr1.log
...
GLOG_logtostderr=1 /PATH_TO/caffe.bin train \
    ...
    --snapshot=snapshots/caffe_combined_train_iter_65000.solverstate   2>&1 | tee combined_virtual_lr2.log
